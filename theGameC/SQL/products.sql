...
VALUES ('俠盜獵車手5', '動作', 'action/GTA5.jpg', '遊戲設定在 2013年 左右的洛聖都及其周邊地區，講述了三個主角麥可．迪聖塔、富蘭克林．柯林頓和崔佛．菲利普的故事。故事發生在《俠盜獵車手4》故事線後約五年。<br>主要是一款開放世界的動作冒險遊戲，玩家扮演不同角色自由探索、任務、駕駛車輛、玩家對戰等。', 1300, '18', 'Rockstar', 'Rockstar', 25000),
       ...
       ('最後生還者2', '動作', 'action/The_last_of_us_2.jpg', '《最後生還者2》是2020年一款由頑皮狗開發的恐怖動作遊戲，劇情以某種會讓人們失去自我意識、化為凶暴感染者的變種蟲草真菌在全球蔓延，導致人類文明全面瓦解崩壞的背景世界觀為基礎，講述在前作《最後生還者》結局喬爾帶著艾莉逃離「火螢」組織的 5 年後，如今已長大成人的艾莉跟歷盡滄桑的喬爾，為了維護她所堅持的正義並尋求終結，再度踏上一場殘酷的冒險旅程。', 1300, '15', 'Naughty Dog', 'Sony', 5000),
       ('惡靈勢力2', '動作', 'action/l4d2.jpg', '與舊作《惡靈勢力》一樣，玩家要和其他倖存者角色（共四人）一起合作，逃離被病毒感染的區域並對抗沿路上的感染者與特殊感染者。玩家要根據沿途所看到的指示逃到下一個安全室，到達指定地點後便要抵抗不斷來襲的感染者與特殊感染者，直到救援的來臨以離開疫區。<br>在逃亡的路上，玩家需要啟動地圖上的一些機關，好讓倖存者能夠繼續前進，但此舉更會引起大量感染者的來襲!', 400, '15', 'Valve', 'Valve', 7000),
